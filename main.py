...
from routes import user, auth, stock_item, purchase, sale_item, sale, kitchen_product, material_request, eservice, cash, links, summary, stock, stockdeprecation
from routes.cash import cash

...
router = APIRouter(prefix="/reports/stockdeprecation", tags=["Reports"])
...
async def send_file(
    ...
    background_tasks.add_task(make_document,"Removal of Items from Stock",items_info,email.email)

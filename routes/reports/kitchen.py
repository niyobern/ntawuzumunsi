...
async def send_file(
    ...
    oauth2.get_current_user), limit: int = 100, skip: int = 100, start: str = "2022-12-18", end: str = "2022-13-30"
    ) -> JSONResponse:
    ...
    background_tasks.add_task(make_document,"Kitchen",products_list,email.email)
